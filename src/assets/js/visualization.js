...
//for mp5 realtime air quality data *turn this off now due to API error
//TODO: Add air quality real-time data back with setting proper error handling
let aqData;
...
// mp5 air quality real-time data *not using at this moment due to api error
// TODO: Put this back with setting proper error handling
// TODO: check needed if the real-time data is properly and efficiently implemented or not
...
window.mpOverlay = (baseMapId, overlayContId, Base, zoomLev, lat, lon) => {
 ...
 //    });
	...
	Promise.all([apiRequest1,apiRequest2,apiRequest3,apiRequest4]).then((data)=> { //add back aqDataCheck
