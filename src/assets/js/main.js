...
window.onload =()=>{
	...
	let grid = null,
		wrapper = document.querySelector('.grid-wrapper'),
	  	...
	  	filterField3 = wrapper.querySelector('.filter-field3'),
	...
	filterFieldValue3 = filterField3.value;
	...
	function filter() {
	    ...
	    let element = item.getElement(),
	        ...
	        isFilter3Match = !filterFieldValue3 ? true : (element.getAttribute(filterAttr3) || '') === filterFieldValue3;
